...
const dict = {
  fr: {
    ...
    svc_pay_paid: "Paiement confirmé",
    svc_pay_method: "Mode",
    ...
    svc_pay_status_AWAITING_PAYMENT: "En attente de paiement",
  ...
  en: {
    ...
    svc_pay_paid: "Payment confirmed",
    ...
    svc_pay_status_AWAITING_PAYMENT: "Awaiting payment",
