...
const dict = {
  fr: {
    ...
    member_profile_title: "Profil",
    member_performance: "Performances",
    member_projects: "Projets",
    member_connections: "Connexions",
    member_rating: "Note",
    member_deliveries: "Livraisons",
    member_trips: "Voyages",
    member_services: "Services",
    member_shops: "Boutiques",
    member_parcels: "Colis",
    member_since: "Membre depuis",
    member_no_projects: "Aucun projet public pour le moment.",
    member_no_connections: "Pas encore de connexions.",
    member_edit_profile: "Modifier mon profil",
    ...
    new_request_title: "Expédier un colis",
    new_request_subtitle:
      "Indiquez le trajet, le poids et la description du colis à envoyer ou recevoir.",
    ...
    profile_banner_hint:
      "Image de couverture affichée sur votre profil (jpeg, png, webp — compressée automatiquement).",
  ...
  en: {
    ...
    member_profile_title: "Profile",
    member_performance: "Performance",
    member_projects: "Projects",
    member_connections: "Connections",
    member_rating: "Rating",
    member_deliveries: "Deliveries",
    member_trips: "Trips",
    member_services: "Services",
    member_shops: "Shops",
    member_parcels: "Parcels",
    member_since: "Member since",
    member_no_projects: "No public projects yet.",
    member_no_connections: "No connections yet.",
    member_edit_profile: "Edit my profile",
    community_message: "Message",
    ...
    new_request_title: "Ship a parcel",
    new_request_subtitle:
      "Enter the route, weight and description of the parcel to send or receive.",
    description: "Description",
    urgency: "Urgency",
    ...
    profile_banner_hint:
      "Cover image shown on your profile (jpeg, png, webp — compressed automatically).",
