...
import { Card, ErrorText, Field, Muted, Screen } from "@/components/ui";
    ...
    <Screen style={{ paddingBottom: 0 }}>
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View>
            <Muted>
              Voyages, besoins d’expédition et services — consultez une annonce
        ...
        ListEmptyComponent={
          loading ? (
            ...
            <Muted>Aucune offre pour le moment.</Muted>
          )
        }
        renderItem={({ item }) => {
